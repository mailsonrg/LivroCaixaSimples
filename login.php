...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body style="padding:10px" onLoad="initTimer();">
        ...
        <table cellpadding="1" cellspacing="10"  width="900" align="center" style="background-color:#033; border-radius: 0px 0px 15px 15px;">

            <tr>
                <td colspan="11" style="background-color:#005B5B; border-radius: 5px 5px 5px 5px;">
                    <h2 style="color:#FFF; margin:5px"><?php echo $mensagem ?>, seja bem vindo ao sistema Livro Caixa Simples.</h2>
                </td>
                <td colspan="2" align="right" style="background-color:#005B5B; border-radius: 5px 5px 5px 5px;">
                    <a style="color:#FFF" title="Este sistema deve ser utilizado apenas para fins pessoais, e não contábeis." href="?mes=<?php echo date('m') ?>&ano=<?php echo date('Y') ?>">Hoje:<strong> <?php echo date('d') ?> de <?php echo mostraMes(date('m')) ?> de <?php echo date('Y') ?><br></strong> Hora: <strong><span id="timer"></span></strong></a>&nbsp; 
                </td>
            </tr>
        </table>
        <br />
