    ...
    <table cellpadding="1" cellspacing="10"  width="1000" align="center" style="background-color:#033">
        <tr>
            ...
            <td colspan="2" align="right" style="background-color:#005B5B;">
                <a style="color:#FFF" href="?mes=<?php echo date('m')?>&ano=<?php echo date('Y')?>">Hoje:<strong> <?php echo date('d')?> de <?php echo mostraMes(date('m'))?> de <?php echo date('Y')?></strong><br></strong> Hora: <strong><span id="timer"></span></strong></a> 
            </td>
        </tr>
        <tr>
            <td width="70">
...
<table border="1" cellpadding="1" cellspacing="10"  width="940" align="center">
    <tr>
        <td align="left"><small><b>Total de Entradas e Saídas mensal.</small>
            <div id="piechart3" style="width: 480px; height: 300px;"></div>

            <td align="left"><small><b>Total de sáidas em todas as contas por mês.</small>
                <div id="donutchart" style="width: 480px; height: 300px;"></div>
            </td>
        </tr>
        <tr>
            <td align="left"><small><b>Total de Entradas e Saídas anual.</small>
                <div id="piechart4" style="width: 480px; height: 400px;"></div>
            </td>
            <td align="left"><small><b>Total gasto em todas as contas por ano.</small>
                <div id="donutchart2" style="width: 480px; height: 400px;"></div>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td><small><b>Percentual de entradas por categoria.</small>
                <div id="piechart2" style="width: 480px; height: 300px;"></div>
            </td>
        ...
        <tr>
            <td colspan="4"><small><b>Progressão do uso dos cartões de crédito.</small>
                <div id="curve_chart" style="width: 960px; height: 500px"></div>
            </td>
        </tr>
        <tr>
            <td align="left"><small><b>Consumo mensal do cartão de crédito por categoria.</small>
                <div id="piechart5" style="width: 480px; height: 300px;"></div>
            </td>
            <td align="left"><small><b>Consumo mensal do cartão de crédito por categoria.</small>
                <div id="piechart6" style="width: 480px; height: 300px;"></div>
            </td>
        </tr>
    </table>
</body>
